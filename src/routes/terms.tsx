...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — EventOrbit AI" },
      { name: "description", content: "The terms governing your use of EventOrbit AI." },
      { property: "og:title", content: "Terms of Service — EventOrbit AI" },
  ...
  component: () => (
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-5 md:px-8 py-16 prose prose-neutral dark:prose-invert">
        <p>By accessing or using EventOrbit AI, you agree to these Terms of Service. Please read them carefully.</p>
        ...
        <h2>Contact</h2>
        <p>Questions? Reach us at legal@eventorbit.ai.</p>
      </section>
    </SiteLayout>
  ),
});

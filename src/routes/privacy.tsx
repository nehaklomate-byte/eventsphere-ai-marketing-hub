  ...
  component: () => (
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-5 md:px-8 py-16 prose prose-neutral dark:prose-invert">
        <p>EventOrbit AI ("we", "us", "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard information when you use our services.</p>
        ...
        <h2>Your rights</h2>
        <p>You may request access, correction or deletion of your data at any time by emailing privacy@eventorbit.ai.</p>
        <h2>Contact</h2>
        <p>Questions? Reach us at privacy@eventorbit.ai.</p>
      </section>
    </SiteLayout>
  ),
});

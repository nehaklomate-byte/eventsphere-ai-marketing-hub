...
export const Route = createFileRoute("/partner-terms")({
  head: () => ({
    meta: [
      { title: "Partner Terms — EventOrbit AI" },
      { name: "description", content: "Key terms for Vendors, Workers and Venue Owners partnering with EventOrbit AI." },
      { property: "og:title", content: "Partner Terms — EventOrbit AI" },
  ...
  component: () => (
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-5 md:px-8 py-16 legal-content">
        ...
        <p>You agree not to direct a customer you connected with through EventOrbit AI to transact outside the Platform for the same event in order to avoid the commission. Doing so may result in suspension of your account.</p>

        <h2>7. Data Use</h2>
        <p>You consent to EventOrbit AI displaying your public profile, ratings, reviews, and portfolio material on the Platform for the purpose of operating the marketplace, as described in our <a href="/privacy">Privacy Policy</a>.</p>

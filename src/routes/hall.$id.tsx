...
import {
  ...
  BadgeCheck, Zap, Accessibility, ArrowUpDown, PartyPopper, ChevronRight,
...
import type { ServiceOfferingMap } from "@/components/HallBookingForm";
...
export function normalize(d: Record<string, unknown>): Hall {
  return {
    id: String(d.id),
    name: String(d.name ?? ""),
        ...
        <aside className="lg:sticky lg:top-24 h-fit">
          <div className="rounded-3xl border border-border bg-card shadow-elegant p-6">
            ...
            <div className="mt-6 space-y-2.5">
              ...
              <p className="text-center text-xs text-muted-foreground">No payment needed to send a request — the venue reviews and confirms.</p>
            </div>
          </div>
        </aside>
      </div>

...
export const Route = createFileRoute("/_authenticated/worker/support")({ component: () => (
  <div className="space-y-6 max-w-3xl">
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <a href="mailto:support@eventorbitnova.com" className="rounded-2xl border border-border bg-card p-6 hover:bg-accent">
        <Mail className="h-5 w-5 text-brand-violet" />
        <div className="mt-3 font-semibold">Email support</div>
        <div className="text-xs text-muted-foreground mt-1">support@eventorbitnova.com · replies within 24h</div>
      </a>

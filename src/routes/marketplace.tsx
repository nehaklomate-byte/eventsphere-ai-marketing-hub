...
type Hall = {import { createFileRoute, Link } from "@tanstack/react-router";
import { useEffect, useState } from "react";
import { SiteLayout } from "@/components/SiteLayout";
import { PageHeader } from "@/components/PageHeader";
import { MapPin, Star, BadgeCheck, Loader2, Search, Users, ArrowRight, Building2, Wrench, HardHat, Sparkles } from "lucide-react";
    ...
    <SiteLayout>
      ...
      <PageHeader
        ...
        <p className="mt-2 text-xs text-muted-foreground">
          {tab === "venue"
            ? "Venues: price is fixed at booking — pick your add-ons and pay directly."
            : `${meta.label}: send a request with what you need, they confirm the price before you pay.`}
        </p>
